...
const Profile = ({ doctorData }) => {
  ...
  //reusable functions for deleting items
  ...
  return (
    <>
      <div>
        <h2 className="text-headingColor font-bold text-[20px] leading-4 mb-8">
          Profile Information
        </h2>
        <form>
          <div className="mb-5">
            <p className="form__layer">Name*</p>
            <input
              type="text"
              name="name"
              value={formData.name}
          ...
          <div className="mb-5">
            <p className="form__layer">Email*</p>
            <input
              type="email"
              name="email"
          ...
          <div className="mb-5">
            <p className="form__layer">Phone*</p>
            <input
              type="number"
              name="phone"
